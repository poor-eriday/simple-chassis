...
/*发送部分*/
uint8_t NRF24L01_TxAddress[5] = {0xF0,0xF0,0xF0,0xF0,0x66};		//发送地址，固定5字节
#define NRF24L01_TX_PACKET_WIDTH		32							//发送数据包宽度，范围：1~32字节
uint8_t NRF24L01_TxPacket[NRF24L01_TX_PACKET_WIDTH];				//发送数据包

/*接收部分*/
uint8_t NRF24L01_RxAddress[5] = {0xF0,0xF0,0xF0,0xF0,0x66};		//接收通道0地址，固定5字节
...
void NRF24L01_Init(void)
{
	...
	NRF24L01_WriteReg(NRF24L01_SETUP_RETR, 0x05);	//设置自动重传，间隔250us，重传3次
	NRF24L01_WriteReg(NRF24L01_RF_CH, 0x02);		//射频通道，频率为(2400 + 2)MHz = 2.402GHz
	NRF24L01_WriteReg(NRF24L01_RF_SETUP, 0x03);		//射频设置，通信速率为2Mbps，发射功率为0dBm
